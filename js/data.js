...
const BUILDINGS = {
  ...
  gunsmith: { n: 'Silahçı', w: 6, h: 6, wall: '#6a5a4a', roof: '#3a2e24', sign: '#909090', svc: ['shop', 'rob'], shop: 'gunsmith' },
  butcher:  { n: 'Kasap & Tuzakçı', w: 7, h: 5, wall: '#8a5040', roof: '#4a2a20', sign: '#a04030', svc: ['shop'], shop: 'butcher' },
  stable:   { n: 'Ahır', w: 9, h: 6, wall: '#9a6a3a', roof: '#6a3a22', sign: '#c08040', svc: ['horses', 'shop', 'horsecare'], shop: 'stable', stable: 1 },
  hotel:    { n: 'Otel', w: 8, h: 7, wall: '#a07a5a', roof: '#5a3a2a', sign: '#e0c080', svc: ['room', 'bath'], tall: 1 },
  bank:     { n: 'Banka', w: 8, h: 7, wall: '#8a4a3a', roof: '#3a2a24', sign: '#d8b040', svc: ['bank', 'robbank'], brick: 1, tall: 1 },
  station:  { n: 'Tren İstasyonu', w: 10, h: 5, wall: '#7a6a50', roof: '#3a4a5a', sign: '#e0e0d0', svc: ['train'] },
  church:   { n: 'Kilise', w: 7, h: 8, wall: '#e8e0d0', roof: '#5a4a44', sign: '#ffffff', svc: ['donate', 'pray'], church: 1 },
  land:     { n: 'Tapu Dairesi', w: 6, h: 5, wall: '#9a8a6a', roof: '#4a4030', sign: '#80a060', svc: ['property'] },
  barber:   { n: 'Berber', w: 5, h: 5, wall: '#c0b0a0', roof: '#6a3030', sign: '#d04040', svc: ['barber'] },
  tailor:   { n: 'Terzi', w: 6, h: 5, wall: '#a09080', roof: '#4a3a4a', sign: '#a080c0', svc: ['shop'], shop: 'tailor' },
  fence:    { n: 'Kaçakçı', w: 6, h: 5, wall: '#5a4a3a', roof: '#2a2420', sign: '#606060', svc: ['shop'], shop: 'fence' },
  mine:     { n: 'Maden Ofisi', w: 7, h: 5, wall: '#6a6058', roof: '#3a3430', sign: '#a0a0a0', svc: ['work', 'shop'], shop: 'mine', work: 'mine' },
  lumber:   { n: 'Kereste Fabrikası', w: 10, h: 6, wall: '#8a6a40', roof: '#4a3a22', sign: '#c0a060', svc: ['work'], work: 'lumber' },
  docks:    { n: 'Liman Deposu', w: 9, h: 5, wall: '#6a6a60', roof: '#3a3a40', sign: '#6080a0', svc: ['work', 'shop'], shop: 'docks', work: 'docks' },
  ranch:    { n: 'Çiftlik Evi', w: 6, h: 5, wall: '#a07850', roof: '#6a4030', sign: '#c0a070', svc: ['work'], work: 'ranch' },
  barn:     { n: 'Ambar', w: 7, h: 6, wall: '#8a2a20', roof: '#4a2a22', sign: '#8a2a20', svc: [] },
  house:    { n: 'Ev', w: 5, h: 5, wall: '#9a8060', roof: '#5a4030', svc: [] },
  property: { n: 'Satılık Mülk', w: 6, h: 5, wall: '#a08a6a', roof: '#4a3a2a', sign: '#80a060', svc: ['home'] },
  ruin:     { n: 'Harabe', w: 6, h: 5, wall: '#5a4a3a', roof: '#2a2420', svc: [], ruin: 1 },
  cabin:    { n: 'Kulübe', w: 6, h: 5, wall: '#6a4a2a', roof: '#3a2a1a', sign: '#a08050', svc: ['shop'], shop: 'trapper' },
  hermit:   { n: 'Münzevi Kulübesi', w: 5, h: 4, wall: '#5a4a32', roof: '#3a3022', svc: ['shop', 'rumor'], shop: 'hermit' },
  lighthouse:{ n: 'Deniz Feneri', w: 4, h: 4, wall: '#e8e0d8', roof: '#a02a20', svc: [], light: 1 },
  mineentrance:{ n: 'Maden Girişi', w: 5, h: 3, wall: '#3a3028', roof: '#2a2420', svc: [], mine: 1 },
};
