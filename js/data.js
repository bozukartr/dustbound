...
const ITEMS = {
  // ---- Yiyecek & İçecek
  beans:        { n: 'Konserve Fasulye', c: 'food', p: 0.1, i: '🥫', e: { hunger: 32, health: 4 }, d: 'Yolun sadık dostu. Ucuz ve doyurucu.' },
  bread:        { n: 'Ekmek', c: 'food', p: 0.05, i: '🍞', e: { hunger: 18 }, d: 'Fırından yeni çıkmış taze bir somun.' },
  jerky:        { n: 'Kuru Et', c: 'food', p: 0.15, i: '🥓', e: { hunger: 15, stamina: 10 }, max: 15, d: 'Tuzlanmış ve kurutulmuş sığır eti.' },
  apple:        { n: 'Elma', c: 'food', p: 0.02, i: '🍎', e: { hunger: 8, thirst: 6 }, max: 20, d: 'Kıtır kıtır bir elma.' },
  berries:      { n: 'Yaban Mersini', c: 'food', p: 0.01, i: '🫐', e: { hunger: 5, thirst: 4 }, max: 30, d: 'Çalılardan toplanmış taze meyveler.' },
  peaches:      { n: 'Konserve Şeftali', c: 'food', p: 0.15, i: '🍑', e: { hunger: 20, thirst: 18 }, d: 'Şuruplu şeftali. Hem doyurur hem susuzluğu giderir.' },
  corn:         { n: 'Mısır', c: 'food', p: 0.03, i: '🌽', e: { hunger: 12 }, max: 15, d: 'Tarladan taze koçan.' },
  chocolate:    { n: 'Çikolata', c: 'food', p: 0.1, i: '🍫', e: { hunger: 8, stamina: 25 }, gift: 10, d: 'Doğu\'dan gelen lüks bir tatlı. Güzel bir hediye olur.' },
  raw_game:     { n: 'Çiğ Av Eti', c: 'food', p: 0.1, i: '🥩', e: { hunger: 12 }, raw: 0.35, cook: 'cooked_game', max: 15, d: 'Pişirilmeden yenirse hasta edebilir.' },
  cooked_game:  { n: 'Pişmiş Av Eti', c: 'food', p: 0.2, i: '🍖', e: { hunger: 36, health: 10 }, max: 15, d: 'Kamp ateşinde kızartılmış et.' },
  raw_big:      { n: 'Çiğ İri Et', c: 'food', p: 0.2, i: '🥩', e: { hunger: 18 }, raw: 0.4, cook: 'cooked_big', max: 10, d: 'Büyük av hayvanından kesilmiş et.' },
  cooked_big:   { n: 'Pişmiş Biftek', c: 'food', p: 0.35, i: '🍖', e: { hunger: 55, health: 20, stamina: 20 }, max: 10, d: 'Kalın, sulu bir biftek.' },
  raw_bird:     { n: 'Çiğ Kuş Eti', c: 'food', p: 0.08, i: '🍗', e: { hunger: 8 }, raw: 0.45, cook: 'cooked_bird', max: 15, d: 'Pişirmeden yeme.' },
  cooked_bird:  { n: 'Kızarmış Kuş', c: 'food', p: 0.15, i: '🍗', e: { hunger: 25, health: 6 }, max: 15, d: 'Nar gibi kızarmış kuş eti.' },
  raw_fish:     { n: 'Çiğ Balık', c: 'food', p: 0.1, i: '🐟', e: { hunger: 10 }, raw: 0.3, cook: 'cooked_fish', max: 15, d: 'Nehirden taze tutulmuş.' },
  cooked_fish:  { n: 'Pişmiş Balık', c: 'food', p: 0.2, i: '🐠', e: { hunger: 30, health: 12 }, max: 15, d: 'Közde pişmiş balık.' },
  ...
  stamina_tonic:{ n: 'Enerji Toniği', c: 'med', p: 0.35, i: '🍶', e: { stamina: 100, energy: 10 }, d: 'Yorgunluğu anında giderir.' },
  snake_oil:    { n: 'Yılan Yağı', c: 'med', p: 0.5, i: '🫙', e: { deadeye: 100, cure: 1 }, d: 'Şarlatanların meşhur iksiri. Şaşırtıcı biçimde işe yarıyor.' },
  antidote:     { n: 'Panzehir', c: 'med', p: 0.75, i: '💊', e: { poison: 1, health: 10 }, max: 5, d: 'Yılan zehrine karşı.' },
  ...
  yarrow:       { n: 'Civanperçemi', c: 'herb', p: 0.05, i: '🌼', e: { health: 8 }, max: 30, d: 'Yara iyileştirici çiçek.' },
  sage:         { n: 'Adaçayı', c: 'herb', p: 0.04, i: '🌿', e: { deadeye: 10 }, max: 30, d: 'Çölün kokulu otu.' },
  mint:         { n: 'Nane', c: 'herb', p: 0.03, i: '🍃', e: { thirst: 5, stamina: 5 }, max: 30, d: 'Serinletici yapraklar.' },
  oregano:      { n: 'Kekik', c: 'herb', p: 0.04, i: '🌿', e: { health: 4 }, max: 30, d: 'Yemeklere lezzet katar.' },
  milkweed:     { n: 'İpekotu', c: 'herb', p: 0.03, i: '🌾', e: { energy: 4 }, max: 30, d: 'Tonik yapımında kullanılır.' },
  mushroom:     { n: 'Mantar', c: 'herb', p: 0.05, i: '🍄', e: { hunger: 6 }, max: 30, d: 'Yenilebilir orman mantarı.' },
  wildflower:   { n: 'Kır Çiçeği', c: 'herb', p: 0.02, i: '💐', gift: 6, max: 30, d: 'Birine hediye etmek için ideal.' },
  // ---- Hayvansal ürünler
  rabbit_pelt:  { n: 'Tavşan Postu', c: 'animal', p: 0.1, i: '🐇', max: 30 },
  deer_hide:    { n: 'Geyik Derisi', c: 'animal', p: 0.75, i: '🦌', max: 20, big: 1 },
  elk_hide:     { n: 'Kızıl Geyik Derisi', c: 'animal', p: 1.5, i: '🦌', max: 15, big: 1 },
  prong_hide:   { n: 'Antilop Derisi', c: 'animal', p: 0.75, i: '🦌', max: 20, big: 1 },
  wolf_pelt:    { n: 'Kurt Postu', c: 'animal', p: 2, i: '🐺', max: 20 },
  coyote_pelt:  { n: 'Çakal Postu', c: 'animal', p: 0.75, i: '🐕', max: 20 },
  fox_pelt:     { n: 'Tilki Postu', c: 'animal', p: 1.25, i: '🦊', max: 20 },
  bear_pelt:    { n: 'Ayı Postu', c: 'animal', p: 6, i: '🐻', max: 10, big: 1 },
  bison_hide:   { n: 'Bizon Derisi', c: 'animal', p: 4, i: '🦬', max: 10, big: 1 },
  cougar_pelt:  { n: 'Puma Postu', c: 'animal', p: 3.5, i: '🐆', max: 10, big: 1 },
  boar_hide:    { n: 'Yaban Domuzu Derisi', c: 'animal', p: 0.6, i: '🐗', max: 20, big: 1 },
  gator_skin:   { n: 'Timsah Derisi', c: 'animal', p: 2.5, i: '🐊', max: 10, big: 1 },
  snake_skin:   { n: 'Yılan Derisi', c: 'animal', p: 0.25, i: '🐍', max: 20 },
  horse_hide:   { n: 'At Derisi', c: 'animal', p: 0.75, i: '🐴', max: 10 },
  feather:      { n: 'Tüy', c: 'animal', p: 0.02, i: '🪶', max: 60 },
  antler:       { n: 'Geyik Boynuzu', c: 'animal', p: 0.4, i: '🦌', max: 20 },
  // ---- Balıklar
  fish_perch:   { n: 'Levrek', c: 'food', p: 0.1, i: '🐟', e: { hunger: 10 }, raw: 0.3, cook: 'cooked_fish', max: 15, d: 'Küçük ama lezzetli.' },
  fish_bass:    { n: 'Karabalık', c: 'food', p: 0.15, i: '🐟', e: { hunger: 12 }, raw: 0.3, cook: 'cooked_fish', max: 15, d: 'Güzel bir av.' },
  fish_trout:   { n: 'Alabalık', c: 'food', p: 0.2, i: '🐟', e: { hunger: 12 }, raw: 0.3, cook: 'cooked_fish', max: 15, d: 'Soğuk suların balığı.' },
  fish_catfish: { n: 'Yayın Balığı', c: 'food', p: 0.25, i: '🐡', e: { hunger: 16 }, raw: 0.3, cook: 'cooked_fish', max: 10, d: 'Bataklıkların bıyıklı devi.' },
  fish_salmon:  { n: 'Somon', c: 'food', p: 0.3, i: '🐟', e: { hunger: 18 }, raw: 0.3, cook: 'cooked_fish', max: 10, d: 'Kuzeyin değerli balığı.' },
  fish_pike:    { n: 'Turna Balığı', c: 'food', p: 0.3, i: '🐟', e: { hunger: 18 }, raw: 0.3, cook: 'cooked_fish', max: 10, d: 'Dişli ve inatçı.' },
  // ---- Değerli
  gold_nugget:  { n: 'Altın Parçası', c: 'valuable', p: 5, i: '✨', max: 99, d: 'Nehir yatağından çıkan saf altın.' },
  silver_ore:   { n: 'Gümüş Cevheri', c: 'valuable', p: 0.75, i: '⚪', max: 50 },
  iron_ore:     { n: 'Demir Cevheri', c: 'valuable', p: 0.1, i: '🪨', max: 50 },
  gold_bar:     { n: 'Altın Külçe', c: 'valuable', p: 150, i: '🟨', max: 10, d: 'Bir servet.' },
  pocket_watch: { n: 'Cep Saati', c: 'valuable', p: 5, i: '⏱️', max: 20 },
  gold_ring:    { n: 'Altın Yüzük', c: 'valuable', p: 8, i: '💍', max: 20, gift: 25, d: 'Evlilik teklifi için de kullanılabilir.' },
  necklace:     { n: 'İnci Kolye', c: 'valuable', p: 10, i: '📿', max: 20, gift: 20 },
  meteorite:    { n: 'Göktaşı Parçası', c: 'valuable', p: 25, i: '☄️', max: 5, d: 'Gökten düşmüş bir taş. Koleksiyoncular bayılır.' },
  // ---- Koleksiyon
  arrowhead:    { n: 'Ok Ucu', c: 'collect', p: 0.5, i: '🔺', max: 50, d: 'Eski zamanlardan kalma yontulmuş taş.' },
  dino_bone:    { n: 'Dinozor Kemiği', c: 'collect', p: 3, i: '🦴', max: 30, d: 'Taşlaşmış kadim bir kemik.' },
  old_coin:     { n: 'Eski Sikke', c: 'collect', p: 1, i: '🪙', max: 50, d: 'İspanyol döneminden kalma bir sikke.' },
  cig_card:     { n: 'Sigara Kartı', c: 'collect', p: 0.1, i: '🃏', max: 50, d: 'Paketlerden çıkan koleksiyon kartı.' },
  // ---- Aletler
  bedroll:      { n: 'Uyku Tulumu', c: 'tool', p: 2, i: '🛏️', max: 1, d: 'Vahşi doğada kamp kurmanı sağlar.' },
  fishing_rod:  { n: 'Olta', c: 'tool', p: 1, i: '🎣', max: 1, d: 'Su kenarında balık tutmanı sağlar.' },
  gold_pan:     { n: 'Altın Eleği', c: 'tool', p: 0.75, i: '🥘', max: 1, d: 'Nehir yataklarında altın aramak için.' },
  pickaxe:      { n: 'Kazma', c: 'tool', p: 1.25, i: '⛏️', max: 1, d: 'Cevher kayalarını kazmak için.' },
  shovel:       { n: 'Kürek', c: 'tool', p: 1, i: '⚒️', max: 1, d: 'Hazine kazmak için.' },
  canteen:      { n: 'Matara', c: 'tool', p: 0.6, i: '🫗', max: 1, d: 'Su taşımanı sağlar. Kuyu ve nehirlerde doldur.' },
  lantern:      { n: 'Fener', c: 'tool', p: 1, i: '🏮', max: 1, d: 'Karanlıkta yolunu aydınlatır.' },
  hay:          { n: 'Saman', c: 'horse', p: 0.05, i: '🌾', max: 15, d: 'Atını besler, sağlığını ve dayanıklılığını yeniler.' },
  ...
  // ---- Giysiler
  coat_duster:   { n: 'Uzun Palto', c: 'clothing', p: 5, i: '🧥', max: 1, coat: { warm: 5, col: '#6b5a44', len: 1 }, d: 'Toz ve rüzgara karşı. (+5°C)' },
  coat_sheep:    { n: 'Kuzu Postu Ceket', c: 'clothing', p: 10, i: '🧥', max: 1, coat: { warm: 11, col: '#8a6a4a', len: 0.6 }, d: 'Sıcak tutar. (+11°C)' },
  coat_fur:      { n: 'Kürk Manto', c: 'clothing', p: 25, i: '🧥', max: 1, coat: { warm: 18, col: '#4a3a2c', len: 0.9 }, d: 'Kuzeyin dondurucu soğuğu için. (+18°C)' },
  coat_poncho:   { n: 'Panço', c: 'clothing', p: 3, i: '🧣', max: 1, coat: { warm: 3, col: '#9a4a2a', len: 0.5, rain: 1 }, d: 'Yağmurdan korur. (+3°C)' },
  coat_linen:    { n: 'Keten Gömlek', c: 'clothing', p: 1.5, i: '👕', max: 1, coat: { warm: -5, col: '#d8cdb4', len: 0 }, d: 'Sıcak çölde serin tutar. (-5°C)' },
  hat_cowboy:    { n: 'Kovboy Şapkası', c: 'clothing', p: 5, i: '🤠', max: 1, hat: 'cowboy', d: 'Güneşten korur.' },
  ...
  // ---- Patlayıcı
  dynamite:      { n: 'Dinamit', c: 'ammo', p: 0.25, i: '🧨', max: 5, d: 'Atılabilir. Dikkatli kullan.' },
};
...
const AMMO = {
  pistol:  { n: 'Tabanca Mermisi', box: 12, p: 0.25, max: 96 },
  repeater:{ n: 'Karabina Mermisi', box: 12, p: 0.3, max: 96 },
  rifle:   { n: 'Tüfek Mermisi', box: 10, p: 0.45, max: 60 },
  shotgun: { n: 'Saçma Fişeği', box: 8, p: 0.35, max: 48 },
  arrow:   { n: 'Ok', box: 10, p: 0.3, max: 40 },
};
const WEAPONS = {
  fists:     { n: 'Yumruk', slot: 0, melee: true, dmg: 10, rate: 0.45, range: 14, i: '✊' },
  knife:     { n: 'Av Bıçağı', slot: 1, melee: true, dmg: 32, rate: 0.5, range: 16, i: '🔪', p: 1.5 },
  cattleman: { n: 'Drover Tabanca', slot: 2, ammo: 'pistol', dmg: 34, rate: 0.38, clip: 6, reload: 1.9, spread: 0.05, range: 260, i: '🔫', p: 14, kind: 'pistol' },
  schofield: { n: 'Schofield Tabanca', slot: 2, ammo: 'pistol', dmg: 42, rate: 0.3, clip: 6, reload: 1.5, spread: 0.04, range: 280, i: '🔫', p: 17, kind: 'pistol' },
  repeater:  { n: 'Karabina Tüfeği', slot: 3, ammo: 'repeater', dmg: 46, rate: 0.55, clip: 12, reload: 2.4, spread: 0.03, range: 340, i: '🔫', p: 18, kind: 'long' },
  winchester:{ n: 'Plainsman Tüfeği', slot: 3, ammo: 'repeater', dmg: 52, rate: 0.45, clip: 14, reload: 2.2, spread: 0.025, range: 360, i: '🔫', p: 25, kind: 'long' },
  rifle:     { n: 'Rolling Block Tüfek', slot: 4, ammo: 'rifle', dmg: 120, rate: 1.3, clip: 1, reload: 1.6, spread: 0.008, range: 560, i: '🎯', p: 28, kind: 'long', scope: true },
  shotgun:   { n: 'Çift Namlulu Av Tüfeği', slot: 5, ammo: 'shotgun', dmg: 22, pellets: 7, rate: 0.5, clip: 2, reload: 2.2, spread: 0.2, range: 150, i: '💥', p: 20, kind: 'long' },
  bow:       { n: 'Av Yayı', slot: 6, ammo: 'arrow', dmg: 75, rate: 0.9, clip: 1, reload: 0.5, spread: 0.02, range: 320, i: '🏹', p: 2.5, kind: 'bow', silent: true, projectile: true },
  dynamite:  { n: 'Dinamit', slot: 7, item: 'dynamite', dmg: 220, rate: 1.0, i: '🧨', throw: true },
  lasso:     { n: 'Kement', slot: 8, dmg: 0, rate: 0.9, range: 120, i: '➰', p: 0.75, lasso: true },
};
const WHEEL_SLOTS = [
  { n: 'Silahsız', w: ['fists'] },
  { n: 'Bıçak', w: ['knife'] },
...
const HORSE_BREEDS = {
  ...
  morgan:     { n: 'Morgan', p: 35, spd: 0.95, sta: 100, hp: 110, cols: ['#5a3b24', '#2b1d14', '#8a6040'] },
  tennessee:  { n: 'Tennessee Walker', p: 60, spd: 1.0, sta: 110, hp: 115, cols: ['#8a5a34', '#c8a070', '#3a2a1e'] },
  mustang:    { n: 'Mustang', p: 80, spd: 1.06, sta: 125, hp: 120, cols: ['#8a5a34', '#b07a48', '#2a1c14', '#d8c0a0'] },
  shire:      { n: 'Shire', p: 110, spd: 0.92, sta: 170, hp: 190, cols: ['#1e1612', '#6a4a30'] },
  standardbred:{ n: 'Standardbred', p: 150, spd: 1.13, sta: 135, hp: 125, cols: ['#3a2418', '#1a1410', '#7a4a2a'] },
  arabian:    { n: 'Arap Atı', p: 450, spd: 1.25, sta: 155, hp: 135, cols: ['#ece8e0', '#1a1612', '#9a9088'] },
};
...
const PROPERTIES = [
  ...
  { id: 'cabin',  n: 'Göl Kıyısı Kulübe', p: 160, near: [0.6, 0.2], perks: 'Ormanın içinde huzurlu bir kulübe.', income: 0 },
...
const ACHIEVEMENTS = [
  ...
  { id: 'rich',      n: 'Cebi Dolu',             d: 'Cebinde $250 biriktir.', perk: 'Dükkanlarda %10 indirim', s: 'maxCash', v: 250 },
  { id: 'tycoon',    n: 'Baron',                 d: 'Toplam $2.500 kazan.', perk: 'Mülk gelirleri %50 artar', s: 'earned', v: 2500 },
  ...
  { id: 'outlaw',    n: 'Kanun Kaçağı',          d: 'Başına $150 ödül konsun.', perk: 'Kanun seni daha çabuk kaybeder', s: 'maxBounty', v: 150 },
...
const BACKGROUNDS = [
  { id: 'farm', n: 'Çiftçi Çocuğu', d: 'Harlow ovalarında büyüdün. Toprağı ve hayvanları bilirsin.', town: 'harlow', money: 6,
  ...
  { id: 'immigrant', n: 'Göçmen', d: 'Okyanusu aşıp Saint Clement limanına ayak bastın. Cebinde biraz para, kafanda hayaller.', town: 'stclement', money: 15,
    skills: { trade: 2, charisma: 2 }, items: { bread: 2, chocolate: 1, canteen: 1, pocket_watch: 1 }, weapons: ['knife'], ammo: {}, horse: null },
  { id: 'outlaw', n: 'Kanun Kaçağı', d: 'Genç yaşta yanlış insanlarla takıldın. Başında küçük bir ödül var.', town: 'dustcreek', money: 10, bounty: 20,
  ...
  { id: 'rail', n: 'Demiryolu İşçisi', d: 'Rayların döşenmesinde ter döktün. Güçlüsün ve yorulmazsın.', town: 'fortmercy', money: 9,
    skills: { strength: 3 }, items: { beans: 3, coffee: 2, canteen: 1, pickaxe: 1 }, weapons: ['knife', 'cattleman'], ammo: { pistol: 18 }, horse: null },
  { id: 'trapper', n: 'Tuzakçı', d: 'Kuzey ormanlarında avcı bir babanın yanında yetiştin.', town: 'cedarfalls', money: 4,
